...
export const router = createRouter({
  ...
  routes: [
    ...
    {
      path: '/mini-projects/public/:attemptId',
      name: 'mini-project-public-detail',
      beforeEnter: requireAuth,
      component: () => import('@/features/mini-projects/views/MiniProjectPublicDetailView.vue'),
    },
    {
    ...
    },
    {
      ...
      beforeEnter: requireAuth,
      meta: { roles: recruiterRoles },
      component: () => import('@/features/recruiter/views/RecruiterAssessmentDetailView.vue'),
    },
    {
      ...
      beforeEnter: requireAuth,
      meta: { roles: recruiterRoles },
      component: () => import('@/features/recruiter/views/RecruiterAssessmentEditView.vue'),
    },
    {
      ...
      beforeEnter: requireAuth,
      meta: { roles: recruiterRoles },
      component: () => import('@/features/recruiter/views/RecruiterAssessmentAttemptsView.vue'),
    },
    {
    ...
    },
    {
      ...
      beforeEnter: requireAuth,
      meta: { roles: adminRoles },
      component: () => import('@/features/admin/views/AdminQuestionsView.vue'),
    },
    {
      ...
      beforeEnter: requireAuth,
      meta: { roles: adminRoles },
      component: () => import('@/features/admin/views/AdminQuestionDetailView.vue'),
    },
    {
