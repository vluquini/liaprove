...
public class UserProfessional extends User{
    ...
    public UserProfessional(UUID id, String name, String email, String password, String occupation, String bio, ExperienceLevel experienceLevel, UserRole role, Integer voteWeight, Integer totalAssessmentsTaken, List<Certificate> certificates, List<Feedback> feedbacks, Float averageScore, LocalDateTime registrationDate, LocalDateTime lastLogin) {
